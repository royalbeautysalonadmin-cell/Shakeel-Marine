    ...
    <>
      ...
      <section className="section-padding bg-off-white">
        <div className="max-w-7xl mx-auto container-padding">
          {/* Filter */}
          <ScrollReveal>
            <div className="flex flex-wrap justify-center gap-2 mb-12" role="group" aria-label="Filter gallery by category">
              {galleryCategories.map((cat) => (
                <button
                  ...
                  className={`max-w-full px-4 sm:px-5 py-2.5 rounded-full text-center text-xs sm:text-sm font-semibold uppercase tracking-wider whitespace-normal break-words transition-all duration-300 ${

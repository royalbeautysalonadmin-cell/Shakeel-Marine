...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    heroHeading: 'Custom Boat & Ship Seats in Kuwait',
    heroDescription:
    ...
    benefits: [
      { title: 'Custom Dimensions', description: 'Seating designed to fit the specific dimensions of your vessel.' },
      { title: 'Material Selection', description: 'Choose from a range of colors and materials suited for marine use.' },
      { title: 'Reupholstery', description: 'Restore existing seats with fresh upholstery and finishing where applicable.' },
      { title: 'Complete Service', description: 'From measurement to installation, we handle the entire project.' },
    ],
    process: [
      { step: 'Consultation', description: 'Discuss your seating requirements and vessel details.' },
      { step: 'Design & Materials', description: 'Select preferred colors, materials and design style.' },
      { step: 'Fabrication', description: 'Seats are custom-built or reupholstered to your specifications.' },
      { step: 'Installation', description: 'Professional fitting and finishing on your vessel.' },
    ],
    faqs: [
      { question: 'Do you make seats for both boats and ships?', answer: 'Yes, we create custom seating for boats and ships of various sizes.' },
      { question: 'Can you reupholster existing boat seats?', answer: 'Yes, we offer reupholstery services to restore and refresh existing marine seating where applicable.' },
      { question: 'Can I choose the material and color?', answer: 'Absolutely. You can select from available colors and materials to match your vessel and style.' },
      { question: 'Do you handle installation?', answer: 'Yes, we provide professional installation as part of the service.' },
    ],
    seo: {
      title: 'Custom Boat & Ship Seats in Kuwait | Shakeel Marine',
      description: 'Custom boat and ship seats, seat covers and reupholstery in Kuwait. Professional marine seating solutions by Shakeel Marine.',
    },
    cta: {
      heading: 'Need Custom Marine Seating?',
      description: 'Tell us about your vessel and seating requirements. We will prepare a tailored quote.',
      buttonText: 'Discuss Your Project',
      whatsappMessage: 'Hello Shakeel Marine, I am interested in custom boat/ship seating. I would like to request a quote.',
    },
  ...
  },
  {
    ...
    benefits: [
      { title: 'Full Customization', description: 'Every project is designed around your style, color and finishing preferences.' },
      { title: 'Versatile Applications', description: 'From jet ski seats to boat interiors and ship seating.' },
      { title: 'Restoration', description: 'Breathe new life into worn or damaged marine upholstery.' },
      { title: 'Attention to Detail', description: 'Clean stitching, precise fitting and professional finishing on every project.' },
    ],
    process: [
      { step: 'Project Discussion', description: 'Share your upholstery needs, style preferences and vessel details.' },
      { step: 'Design Planning', description: 'We plan the design, materials and color scheme with you.' },
      { step: 'Custom Fabrication', description: 'Your upholstery is crafted to the agreed specifications.' },
      { step: 'Fitting & Finishing', description: 'Professional installation and quality finishing.' },
    ],
    faqs: [
      { question: 'What types of marine upholstery do you offer?', answer: 'We provide custom upholstery for jet ski seats, boat seats, boat interiors, ship seats and general marine seating applications.' },
      { question: 'Can you reupholster old marine seats?', answer: 'Yes, we offer restoration and reupholstery for existing marine seating where the project is feasible.' },
      { question: 'Do I need to bring my vessel?', answer: 'Contact us to discuss the best approach for your specific project — it depends on the scope of work.' },
      { question: 'Can I choose the exact colors and design?', answer: 'Yes. Full customization of colors, patterns, stitching and design is available.' },
    ],
    seo: {
      title: 'Marine Upholstery in Kuwait | Shakeel Marine',
      description: 'Custom marine upholstery in Kuwait for jet skis, boats and ships. Professional design, fabrication and installation by Shakeel Marine.',
    },
    cta: {
      heading: 'Start Your Upholstery Project',
      description: 'Share your vision and vessel details. We will work with you to create a custom marine upholstery solution.',
      buttonText: 'Request a Quote',
      whatsappMessage: 'Hello Shakeel Marine, I am interested in custom marine upholstery. I would like to request a quote.',
    },
